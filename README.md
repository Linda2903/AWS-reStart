...
Questo repository raccoglie il materiale didattico, gli esercizi e i progetti sviluppati durante il percorso AWS re/Start organizzato da Edgemony in collaborazione con AWS.
...
Trainer
Emanuele Gurini: Responsabile dei moduli tecnici (Python, Django, AWS, Linux, AI Tools).
Paola Lombardi: Responsabile del modulo di Project Management ed AI Tools.
